    ...
    return (
        ...
        <div id="research">
            ...
            <div className="research-cell">
                ...
                <a href="#" className="research-sub">Get an overview of RU's research</a>
                </div>
            </div>  
            <hr />
            <div className="research-cell">
                ...
                <a href="#" className="research-sub">Get support for your research</a>
                </div>
            </div>   
            <hr /> 
            <div className="research-cell">
                ...
                <a href="#" className="research-sub">Find people, search facilities</a> 
                </div>
            </div>
            <hr />
            <div className="research-cell">
                ...
                <a href="#" className="research-sub">Learn how we impact society</a> 
                </div>
            </div> 
            <hr /> 
            <div className="research-cell">
                ...
                <a href="#" className="research-sub">Summary of our funding</a>
                </div>
            </div>
            </div>  
      </div>
